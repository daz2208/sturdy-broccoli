...
def hash_password(password: str) -> str:
    ...
    Note:
        Bcrypt has a 72-byte limit. Passwords longer than 72 characters
        are truncated to comply with this limitation.
    """
    # Truncate to 72 chars to comply with bcrypt's limitation
    # This should never happen due to Pydantic validation, but protects
    # against edge cases in tests or direct API calls
    if len(password) > 72:
